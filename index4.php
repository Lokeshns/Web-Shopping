...
$results = $mysqli->query("SELECT pro_code, name, pro_desc, img_name, price FROM products2 ORDER BY id ASC");
if($results){ 
...
$products_item .= <<<EOT
    <li class="product">
    <form method="post" action="cart_update4.php">
...
if(isset($_SESSION["cart_products"]) && count($_SESSION["cart_products"])>0)
{
    ...
    echo '<form method="post" action="cart_update4.php">';
    ...
    echo '<td colspan="4">';
    echo '<button type="submit">Update</button><a href="view_cart4.php" class="button">Checkout</a>';
    echo '</td>';
    echo '</tbody>';
    echo '</table>';
